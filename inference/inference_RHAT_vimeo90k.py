...
import argparse
from archs.psrt_recurrent_hat_arch import BasicRecurrentHAT
...
def main():
    ...
    model_path = 'experiments/HAT_PSRTRecurrent_mix_precision_Vimeo_300K_HAT_small_batch_2_4/models/net_g_26000.pth'
    test_name = f'HAT-small-2-4'
    lr_folder = 'data/vimeo90k/BIx4'
    gt_folder = 'data/vimeo90k/GT'
    # save_folder = f'/data_ssd/swshi/SwinVSR_Vimeo/results/{test_name}'
    save_folder = f'data/swshi/SwinVSR_Vimeo/results/{test_name}'
    os.makedirs(save_folder, exist_ok=True)

    # set up the models
    model = BasicRecurrentHAT(mid_channels=64,
                 embed_dim=64,
                 depths=[4, 4, 4],
                 num_heads=[4,4,4],
                 window_size=[3, 8, 8],
